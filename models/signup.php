<?php
    ...
    function insert_user(){
        ...
        $sql = "INSERT INTO users (user_first, user_last, user_email, user_uid, user_pwd, phone_number)
            VALUES ('".$required[0]."','".$required[1]."','".$required[2]."', '".$required[3]."','".$required[4]."' , '".$required[5]."')";
        ...
        if($db->query($sql)){
            ...
            $_SESSION['number_phone'] = $required[5];
            return true;
        }else 
            return false;
